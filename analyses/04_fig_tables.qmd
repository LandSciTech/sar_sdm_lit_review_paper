...
plt_n_sdm <- dat_n_sdm %>%
  ...
  # scale_color_manual(values = cols4all::c4a("area9"))+
...
# point range to show median and IQR of n papers by taxonomic group
# ggplot()+
# geom_linerange(data = dat_med_n_sdm, aes(med_n_sdm, xmin = q1, xmax = q2,
#                y = 2.7*1e7+1:9*1000000, col = taxonomic_group))+
# geom_point(data = dat_med_n_sdm, aes(med_n_sdm,  
#            y = 2.7*1e7+1:9*1000000, col = taxonomic_group))
...
fig_pnl_sdm_re <- re_na_sdm_bin %>%
  ...
  scale_fill_manual(values=c(#'#2f006a', '#553b92','#8d85be','#d0d1e5','grey',
                             "#4A1486", "#6A51A3", "#807DBA", "#9E9AC8", "grey")) +
  ylab("Proportion of species") +
  xlab(element_blank()) +
