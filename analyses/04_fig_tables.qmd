...
**Number of SDM papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Number of SDM papers that included at least one species from each taxonomic group. Note that a partial literature review was completed for Birds"
...
**Number of SDM-CC papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Number of SDM-CC papers that included at least one species from each taxonomic group. Note that a partial literature review was completed for Birds"
...
**Number of Canada-inclusive SDM papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Total number of Canada-inclusive SDM papers by taxa"
paper_db %>%
  filter(sdm_ca == "1") %>%
  group_by(taxonomic_group) %>%
  summarise(n_ppr = n_distinct(paperID)) %>%
...
**Number of Canada-inclusive SDM-CC papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Total number of Canada-inclusive SDM-CC papers by taxa"
paper_db %>%
  filter(cc_sdm_ca == "1") %>%
  group_by(taxonomic_group) %>%
  summarise(n_ppr = n_distinct(paperID)) %>%
...
**Number of Canada-exclusive SDM papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Total number of Canada-exclusive SDM papers by taxa"
paper_db %>%
  filter(sdm_na == "1" & sdm_ca == "0") %>%
  group_by(taxonomic_group) %>%
  summarise(n_ppr = n_distinct(paperID)) %>%
  arrange(n_ppr) %>% kable()
```

**Number of Canada-exclusive SDM-CC papers by taxa**

```{r, echo = FALSE}
#| tbl-cap: "Total number of Canada-exclusive SDM-CC papers by taxa"
paper_db %>%
  filter(cc_sdm_na == "1" & cc_sdm_ca == "0") %>%
  group_by(taxonomic_group) %>%
  summarise(n_ppr = n_distinct(paperID)) %>%
  arrange(n_ppr) %>% kable()
```

**FUll vs partial range in SDM papers**

```{r, echo = FALSE}
#| tbl-cap: "Total number of SDM papers that used full vs partial range species data to build SDM"
...
```{r, echo = FALSE}
#| tbl-cap: "Number of species included in a full range SDM at least once"
...
**FUll vs partial range in SDM-CC papers**

```{r, echo = FALSE}
#| tbl-cap: "Total number of SDM-CC papers that used full vs partial range species data to build SDM"
...
```{r, echo = FALSE}
#| tbl-cap: "Number of species included in a full range SDM-CC at least once"
